...
When `dev-recapper` is invoked again after more user interaction, treat the existing recap note as the baseline when it appears to describe the same session or workstream.
