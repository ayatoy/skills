...
- `$PWD/docs/walkthroughs/yyyy-MM-dd'T'HH-mm-ss'Z'_*.md`
...
- Save the reading path under `$PWD/docs/walkthroughs/` with a `yyyy-MM-dd'T'HH-mm-ss'Z'_` UTC filename prefix.
